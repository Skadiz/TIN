...
CREATE TABLE IF NOT EXISTS `TIN2021`.`Reservation`
    ( `_id` INT UNSIGNED NOT NULL AUTO_INCREMENT ,
      ...
      CONSTRAINT `roomfk` FOREIGN KEY (`roomd`) REFERENCES `TIN2021`.`Room` (`_id`)
    ) ENGINE = InnoDB CHARSET=utf8 COLLATE utf8_general_ci;
...
INSERT IGNORE INTO `TIN2021`.`Room` (`_id`, `number`, `type`,  `price`, `numberOfPlaces`) VALUES
